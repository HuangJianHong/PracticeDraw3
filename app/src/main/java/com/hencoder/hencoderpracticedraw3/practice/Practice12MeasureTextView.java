...
public class Practice12MeasureTextView extends View {
    ...
    String text2 = "4.5";
    String text3 = "公斤";
    private float measureOne;
    private float measureTwo;
...

    {
        ...
        measureOne = paint1.measureText(text1);
        measureTwo = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + measureOne, 200, paint2);
        canvas.drawText(text3, 50 + measureOne + measureTwo, 200, paint1);
    }
}
